      ...
      <ul class="mt-2 flex-1 space-y-1 overflow-y-auto px-2 pb-safe-3">
        ...
        @if (routineService.activeDays().length > 0) {
          <li class="px-3 pb-1 pt-4">
            <span class="text-xs font-semibold uppercase tracking-wide text-gray-400">{{ lang.t('menu.routines') }}</span>
          </li>
        ...
        <!-- Separador -->
        <li class="px-3 pb-1 pt-4">
          <span class="text-xs font-semibold uppercase tracking-wide text-gray-400">{{ lang.t('menu.config') }}</span>
        </li>
