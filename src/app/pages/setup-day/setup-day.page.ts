    ...
    <div class="p-4">
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-sm text-gray-500">{{ exercises().length }} ejercicios</p>
        </div>
      </div>
      ...
      @if (exercises().length > 0) {
              ...
              <div class="flex items-center gap-3 px-4 py-3">
                ...
                <div class="min-w-0 flex-1">
                  ...
                  <p class="text-xs text-gray-500">
                    {{ exercise.sets }}x{{ exercise.reps }} {{ exercise.unit === 'Repeticiones' ? 'reps' : 'min' }}
                  </p>
                </div>
              ...
              @if (editingId() === exercise.id) {
                <div class="border-t bg-gray-50 px-4 py-3">
                  <div class="grid grid-cols-2 gap-3">
                    <!-- Sets -->
                    <div>
                      <label class="text-xs font-medium text-gray-600">Series</label>
                      <input
                        type="number"
                    ...
                    <!-- Reps -->
                    <div>
                      <label class="text-xs font-medium text-gray-600">Repeticiones</label>
                      <input
                        type="number"
                    ...
                    <!-- Descanso entre sets -->
                    <div>
                      <label class="text-xs font-medium text-gray-600">Descanso sets (seg)</label>
                      <input
                        type="number"
                    ...
                    <div class="col-span-2">
                      <label class="text-xs font-medium text-gray-600">Descanso entre ejercicios (seg)</label>
                      <input
                        type="number"
        ...
        <div class="mt-12 text-center">
          ...
          <p class="mt-2 text-sm text-gray-500">No hay ejercicios configurados</p>
          <p class="text-xs text-gray-400">Agrega ejercicios para este día</p>
        </div>
      }
